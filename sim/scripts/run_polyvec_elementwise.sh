...
iverilog -g2012 -Wall -I "$R/rtl/common" -s "$TOP" -o "$O/t.vvp" \
 ...
 "$R/rtl/poly/poly_workspace.v" "$R/rtl/poly/poly_binary_pipe.v" "$R/rtl/poly/poly_add_pipe.v" "$R/rtl/poly/poly_sub_pipe.v" "$R/rtl/poly/poly_transform_pipe.v" "$R/rtl/poly/poly_ntt_pipe.v" "$R/rtl/poly/poly_intt_pipe.v" \
 "$R/rtl/poly/polyvec_workspace.v" "$R/rtl/poly/polyvec_elementwise_pipe.v" "$R/rtl/poly/polyvec_ntt_pipe.v" \
