...
iverilog -g2012 -Wall -I "$ROOT/rtl/common" -s tb_poly_ntt_intt_roundtrip -o "$OUT/tb_poly_ntt_intt_roundtrip.vvp" \
 ...
 "$ROOT/tb/block/tb_poly_ntt_intt_roundtrip.v"
timeout 70s vvp "$OUT/tb_poly_ntt_intt_roundtrip.vvp" +VECTOR_FILE="$OUT/poly_roundtrip.mem" "${DEBUG_ARGS[@]}"|tee "$ROOT/sim/logs/poly_ntt_intt_roundtrip.log"
grep -q 'PASS tb_poly_ntt_intt_roundtrip' "$ROOT/sim/logs/poly_ntt_intt_roundtrip.log"
