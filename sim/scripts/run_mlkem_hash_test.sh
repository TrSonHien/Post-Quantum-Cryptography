...
FILES=(keccak_round.v keccak_f1600_core.v keccak_sponge_ctx.v keccak_hash_stream.v sha3_256_stream.v sha3_512_stream.v shake128_stream.v shake256_stream.v mlkem_h.v mlkem_g.v mlkem_j.v mlkem_prf.v mlkem_xof.v);RTL=();for f in "${FILES[@]}";do RTL+=("$ROOT/rtl/keccak/$f");done
