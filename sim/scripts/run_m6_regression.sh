...
run bits_bytes 30s 256 "$ROOT/sim/scripts/run_bits_bytes_pipe.sh"
run compress 90s 9987 "$ROOT/sim/scripts/run_compress_coeff_pipe.sh"
run decompress 90s 1042 "$ROOT/sim/scripts/run_decompress_coeff_pipe.sh"
...
run cbd_pair 90s 8704 "$ROOT/sim/scripts/run_cbd_pair_pipe.sh"
