...
timeout 30s vvp "$OUT/tb_poly_reduce_pipe.vvp" +INPUT_FILE="$OUT/poly_reduce_input.mem" +EXPECTED_FILE="$OUT/poly_reduce_expected.mem" "${DEBUG_ARGS[@]}" | tee "${ROOT_DIR}/sim/logs/poly_reduce_pipe.log"
