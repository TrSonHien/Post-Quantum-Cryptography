...
// Module: poly_sub
// Description:
//   Coefficient-wise modular subtraction of two Kyber polynomials.
//
...
//
// C reference:
//   kyber768/poly.c: poly_sub()
//
// Important difference from the C reference:
//   The C implementation performs lazy signed subtraction and reduces later.
//   This RTL follows the project-wide canonical coefficient convention and
//   therefore applies modular correction immediately through mod_sub.
//
// Architecture:
...
//   - Two parallel mod_sub instances
//
// Performance:
 ...
 * Submodules: mod_sub, poly_buffer.
