 ...
 * Submodules: mod_add_pipe, mod_sub_pipe, poly_workspace.
...
module poly_binary_pipe
    ...
    poly_workspace ws_a(
                           ...
                           .load_ready(),
                           .acquire_internal(accepted_start),
                           .init_internal(1'b0),
                           .init_domain(2'b0),
                           .publish_result(1'b0),
                           .release_internal(release_sources),
                           .owner(a_owner),
                           .complete(a_complete),
                           .domain(a_domain),
                           .error(a_error),
                           ...
                           .int_pair_rd_valid(a_pair_valid),
                           .int_pair_rd0(a0),
                           .int_pair_rd1(a1),
                           .int_wr_en(1'b0),
                           .int_wr_idx(8'b0),
    ...
    poly_workspace ws_b(
                           ...
                           .int_pair_rd_req(pair_req),
                           .int_pair_rd_idx(issue_pair),
                           .int_pair_rd_valid(b_pair_valid),
                           .int_pair_rd0(b0),
                           .int_pair_rd1(b1),
                           .int_wr_en(1'b0),
                           .int_wr_idx(8'b0),
    ...
    poly_workspace ws_r(
                           ...
                           .init_internal(accepted_start),
                           .init_domain(a_domain),
                           ...
                           .int_wr_idx(8'b0),
                           .int_wr_coeff(12'b0),
                           .int_pair_wr_en(out0_valid && out1_valid),
                           .int_pair_wr_idx(pair_d1),
                           .int_pair_wr0(out0),
                           .int_pair_wr1(out1),
                           .zeroize_req(child_zeroize_req),
    ...
    generate
        if (OP_SUB) begin
            mod_sub_pipe lane0(.clk(clk),
                               .rst_n(rst_n),
                               .in_valid(arith_in_valid && !zeroize_busy),
                               .a(a0),
                               .b(b0),
    ...
    always @(posedge clk) begin
        ...
        if (!rst_n) begin
            ...
            case (state)
                ...
                DRAIN:
                    if (out0_valid && out1_valid && pair_d1 == 127)
                        state <= PUBLISH;
                PUBLISH:
                    state <= DONE;
                DONE: begin
