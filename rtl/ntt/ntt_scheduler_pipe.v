...
module ntt_scheduler_pipe
    ...
    wire [2 : 0] src_p = (stage == 3'd0) ? 3'd7 : (stage == 3'd1) ? 3'd7
                                              : (stage == 3'd2)   ? 3'd6
                                              : (stage == 3'd3)   ? 3'd5
                                              : (stage == 3'd4)   ? 3'd4
                                              : (stage == 3'd5)   ? 3'd3
    ...
    wire [2 : 0] src_r = (stage == 3'd0) ? 3'd7 : (stage == 3'd1) ? 3'd6
                                              : (stage == 3'd2)   ? 3'd5
                                              : (stage == 3'd3)   ? 3'd4
                                              : (stage == 3'd4)   ? 3'd3
                                              : (stage == 3'd5)   ? 3'd2
    ...
    wire [2 : 0] dst_p = (stage == 3'd0) ? 3'd7 : (stage == 3'd1) ? 3'd6
                                              : (stage == 3'd2)   ? 3'd5
                                              : (stage == 3'd3)   ? 3'd4
                                              : (stage == 3'd4)   ? 3'd3
                                              : (stage == 3'd5)   ? 3'd2
    ...
    wire [2 : 0] dst_r = (stage == 3'd0) ? 3'd6 : (stage == 3'd1) ? 3'd5
                                              : (stage == 3'd2)   ? 3'd4
                                              : (stage == 3'd3)   ? 3'd3
                                              : (stage == 3'd4)   ? 3'd2
                                                                  : 3'd1;
