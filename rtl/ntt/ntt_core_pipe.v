 ...
 * Submodules: butterfly_pipe, fixed_latency_delay, ntt_bank_map, ntt_pingpong_banks, ntt_scheduler_pipe, zetas_rom.
...
module ntt_core_pipe
    ...
    function [2 : 0] fwd_src_pair_bit;
        ...
        begin
            case (stage)
                3'd0:
                    fwd_src_pair_bit = 3'd7;
                3'd1:
                    fwd_src_pair_bit = 3'd7;
                3'd2:
                    fwd_src_pair_bit = 3'd6;
                3'd3:
                    fwd_src_pair_bit = 3'd5;
                3'd4:
                    fwd_src_pair_bit = 3'd4;
                3'd5:
                    fwd_src_pair_bit = 3'd3;
                default:
                    fwd_src_pair_bit = 3'd2;
            endcase
        end
    endfunction
    ...
    function [2 : 0] fwd_src_addr_bit;
        ...
        begin
            case (stage)
                3'd0:
                    fwd_src_addr_bit = 3'd7;
                3'd1:
                    fwd_src_addr_bit = 3'd6;
                3'd2:
                    fwd_src_addr_bit = 3'd5;
                3'd3:
                    fwd_src_addr_bit = 3'd4;
                3'd4:
                    fwd_src_addr_bit = 3'd3;
                3'd5:
                    fwd_src_addr_bit = 3'd2;
                default:
                    fwd_src_addr_bit = 3'd1;
            endcase
        end
    endfunction
    ...
    function [2 : 0] fwd_dst_pair_bit;
        ...
        begin
            case (stage)
                3'd0:
                    fwd_dst_pair_bit = 3'd7;
                3'd1:
                    fwd_dst_pair_bit = 3'd6;
                3'd2:
                    fwd_dst_pair_bit = 3'd5;
                3'd3:
                    fwd_dst_pair_bit = 3'd4;
                3'd4:
                    fwd_dst_pair_bit = 3'd3;
                3'd5:
                    fwd_dst_pair_bit = 3'd2;
                default:
                    fwd_dst_pair_bit = 3'd1;
            endcase
        end
    endfunction
    ...
    function [2 : 0] fwd_dst_addr_bit;
        ...
        begin
            case (stage)
                3'd0:
                    fwd_dst_addr_bit = 3'd6;
                3'd1:
                    fwd_dst_addr_bit = 3'd5;
                3'd2:
                    fwd_dst_addr_bit = 3'd4;
                3'd3:
                    fwd_dst_addr_bit = 3'd3;
                3'd4:
                    fwd_dst_addr_bit = 3'd2;
                default:
                    fwd_dst_addr_bit = 3'd1;
            endcase
        end
    endfunction
    ...
    always @(posedge clk) begin
        if (!rst_n) begin
            ...
            child_done_seen <= 5'd0;
            scrub_addr <= 7'd0;
            local_scrub_done <= 1'b0;
            ...
            if (zeroize_req === 1'b1 && !zeroize_busy) begin
                ...
                write_setup_valid_d <= 0;
                write_setup_last_stage_d <= 0;
                write_setup_last_transform_d <= 0;
                write_setup_stage_d <= 0;
                ...
                if (!local_scrub_done) begin
                    preload_lo[scrub_addr] <= 0;
                    preload_lo_seen[scrub_addr] <= 0;
