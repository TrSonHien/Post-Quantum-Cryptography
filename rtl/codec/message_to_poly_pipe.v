...
module message_to_poly_pipe(
 ...
 poly_decode_decompress_pipe #(.D(1))u(clk,rst_n,start,busy,done,error,in_valid,in_ready,in_data,in_keep,in_last,out_valid,out_ready,out_coeff,out_index,out_domain,zeroize_req,zeroize_busy,zeroize_done);
endmodule
