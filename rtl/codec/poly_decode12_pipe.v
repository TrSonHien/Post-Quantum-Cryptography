...
module poly_decode12_pipe(
 ...
 wire child_error;
 byte_decode_poly_pipe #(.D(12)) u(clk,rst_n,start,busy,done,child_error,in_valid,in_ready,in_data,in_keep,in_last,out_valid,out_ready,out_coeff,out_index,noncanonical_seen,zeroize_req,zeroize_busy,zeroize_done);
