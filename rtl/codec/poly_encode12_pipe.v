...
module poly_encode12_pipe(
 ...
 wire child_error;
 byte_encode_poly_pipe #(.D(12)) u(clk,rst_n,start,busy,done,child_error,in_valid,in_ready,in_coeff,out_valid,out_ready,out_data,out_keep,out_last,zeroize_req,zeroize_busy,zeroize_done);
