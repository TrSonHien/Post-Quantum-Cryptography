 ...
 * Latency / completion: one-cycle source read; role swap and zeroize completion are control-dependent.
 * State ownership: owns control and/or pipeline registers.
 * Submodules: ntt_bank_map, sync_1r1w_ram.
...
module ntt_pingpong_banks
    ...
    ntt_bank_map u_src_map0(src_index0,
                            src_pair_bit,
                            src_addr_bit,
                            src_xor_layout,
                            src_bank0_sel,
                            src_addr0);
    ntt_bank_map u_src_map1(src_index1,
                            src_pair_bit,
                            src_addr_bit,
                            src_xor_layout,
                            src_bank1_sel,
                            src_addr1);
    ntt_bank_map u_dst_map0(dst_index0,
                            dst_pair_bit,
                            dst_addr_bit,
                            dst_xor_layout,
                            dst_bank0_sel,
                            dst_addr0);
    ntt_bank_map u_dst_map1(dst_index1,
                            dst_pair_bit,
                            dst_addr_bit,
                            dst_xor_layout,
                            dst_bank1_sel,
...
`endif
    ...
    sync_1r1w_ram #(.DATA_WIDTH(DATA_WIDTH))
        u_set_a_bank0(clk,
                      rst_n,
                      src_rd_en && !role_select && !zeroize_busy,
                      src_phys_addr0,
                      a0_rd_valid,
                      a0_rd_data,
                      a0_wr_en,
