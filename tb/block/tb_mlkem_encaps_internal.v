...
module tb_mlkem_encaps_internal;
 ...
 initial begin string dir;repeat(2)tick;rst_n=1;tick;if(!$value$plusargs("VEC_DIR=%s",dir))$fatal;$readmemh({dir,"/smoke_ek.mem"},ek);$readmemh({dir,"/smoke_m.mem"},m);$readmemh({dir,"/smoke_k.mem"},k);$readmemh({dir,"/smoke_c.mem"},c);
