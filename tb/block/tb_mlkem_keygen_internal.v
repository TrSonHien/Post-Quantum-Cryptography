...
module tb_mlkem_keygen_internal;
 ...
 initial begin string dir;repeat(2)tick;rst_n=1;tick;if(!$value$plusargs("VEC_DIR=%s",dir))$fatal;$readmemh({dir,"/smoke_d.mem"},d);$readmemh({dir,"/smoke_z.mem"},z);$readmemh({dir,"/smoke_ek.mem"},ek);$readmemh({dir,"/smoke_dk.mem"},dk);
